 ...
 * §2-7 Dark Zone: About, Testimonials, Programs, Methodology, Credentials, Journal
 * §8 ConversionStrip — light zone
 * §9 FAQ (#faq) — light zone
 * §10 Contact (#contact) — light zone
 * §11 Marquee — dark strip
 */
  ...
  return (
    <>
      ...
      <main id="main-content" className="bg-background text-foreground min-h-screen">
        ...
        {/* §2-7: DARK ZONE — dramatic light→dark transition */}
        <DarkZoneWrapper>
          {/* §2: ABOUT */}
          <AboutSection />
        ...
        {/* §8: CONVERSION STRIP — Light zone */}
        <ConversionStrip />

        {/* §8.5: STUDENT STRIP — For existing students */}
        <StudentStrip />

        {/* §9: FAQ — Light zone */}
        <FAQ />

        {/* §10: CONTACT — Light zone */}
        <section
          id="contact"
